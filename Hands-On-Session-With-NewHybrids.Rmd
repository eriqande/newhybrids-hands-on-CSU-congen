...
Go to
[https://github.com/eriqande/newhybrids/blob/master/NewHybrids_PreDefdViews.txt](https://github.com/eriqande/newhybrids/blob/master/NewHybrids_PreDefdViews.txt) and download the file.
...
OK, there are some birds with a lot of missing loci.  Apparently this was from lcWGS.  I don't
know how the calls were made.  Not by beagle imputation.  But at any rate, a lower call rate means
...
Then you can quickly run each of those by changing into the appropriate directory
and doing:
```sh
